...
function showSlides(n) {
    var slides = document.getElementsByClassName("mySlides"); //This take all elements with the class name "mySlides" and stores them in the variable array "slides"
    ...
    if (n > slides.length) {slideIndex = 1} // if n (the number passed into the function) is great than the length of the array "slides", the slideIndex is set to 1
    if (n < 1) {slideIndex = slides.length}; //if n (thenumber passed into the function) is less than 1, the slideIndex is set to the lenth of the array "slides"
...
//This code will creat slow the contact form when the user clicks off of it
